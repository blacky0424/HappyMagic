...
public class ResultScene : MonoBehaviour
{
    ...
    const string footString = "取得した足跡の数:";
    ...
    void Start()
    {
        ...
        Footsteps = GameObject.Find("Footsteps").GetComponent<Text>();
    ...
    void Update()
    {   // sceneTransitonがtrueなら画面タッチでシーン遷移
        if (sceneTransition)
        {
    ...
    IEnumerator imagedisplay()
    {
        ...
        Footsteps.text = footString + ScoreManager.Instance.FootPrint.ToString() + "つ";
